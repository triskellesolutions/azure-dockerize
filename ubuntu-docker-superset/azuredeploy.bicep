...
var nicName_var = 'tss-superset-nic'
var extensionName = 'tss-superset-de'
var addressPrefix = '10.0.0.0/16'
var subnetName = 'Subnet'
var subnetPrefix = '10.0.0.0/24'
var diskStorageType = 'StandardSSD_LRS'
var publicIPAddressName_var = 'tss-superset-ip'
var publicIPAddressType = 'Static'
var vmName_var = 'tss-superset-vm'
var virtualNetworkName_var = 'tss-superset-vnet'
...
var networkSecurityGroupName_var = 'tss-superset-nsg'
...
resource vmName_install 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = {
  ...
  properties: {
    ...
    settings: {
      skipDos2Unix: false
      fileUris: [
        'https://raw.githubusercontent.com/triskellesolutions/azure-dockerize/main/ubuntu-docker-superset/install.sh'
      ]
    }
    protectedSettings: {
