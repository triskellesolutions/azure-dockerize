...
var publicIPAddressName_var = 'tss-outline-vpn-ip'
var publicIPAddressType = 'Static'
var vmName_var = 'tss-outline-vpn-vm'
var virtualNetworkName_var = 'tss-outline-vpn-vnet'
...
var networkSecurityGroupName_var = 'tss-outline-vpn-nsg'
...
resource vmName_install_sfpt 'Microsoft.Compute/virtualMachines/extensions@2020-06-01' = {
  ...
  properties: {
    ...
    settings: {
      skipDos2Unix: false
      fileUris: [
        'https://raw.githubusercontent.com/triskellesolutions/azure-dockerize/main/ubuntu-docker-outline-vpn/install.sh'
      ]
    }
    protectedSettings: {
